    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="section-heading animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s' }}>
            Pay Indian QR Codes <br />
            <span className="bg-gradient-to-r from-crypto-blue via-crypto-green to-crypto-orange bg-clip-text text-transparent">Using Crypto</span>
          </h1>
          
          <p className="section-subheading animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
            ...
            <Button variant="outline" className="border-white/20 hover:bg-white/5 text-white px-8 py-6 rounded-full text-lg">
              How it Works
            </Button>
          </div>
          
          {/* Animated illustration */}
          <div className="relative w-full max-w-3xl mx-auto mt-8 animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
            <div className="relative bg-crypto-dark/60 backdrop-blur-sm border border-white/10 rounded-2xl p-8 overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8 relative">
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <span className="text-xs text-gray-400">Instant Conversion</span>
                </div>
                
                <div className="flex-1 flex flex-col items-center">
                  <div className="crypto-icon orange-glow animate-float" style={{ animationDelay: '1s' }}>
