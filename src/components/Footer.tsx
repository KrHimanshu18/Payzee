        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400">
              Bridging the gap between cryptocurrency and everyday UPI payments in India.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Crypto to INR</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">UPI QR Payments</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Merchant Solutions</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">API Integration</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Corporate Accounts</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Supported Cryptocurrencies</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">support@cryptoqr.com</span>
              </li>
              <li className="flex items-center gap-3">
